...
<form action="createCustomerAccount.php" method="post">
  <div class="main">
    <h1>Create Customer Account</h1>
    <p>Please fill in this form to create an Customer account.</p>
    <hr>
    ...
    <input type="text" placeholder="Enter Address" name="street_name" required>
    
    <label for="apt_number"><b>Apartment Number<b></label> 
    <input type="text" placeholder="Enter Apartment Number" name="apt_number" required>
