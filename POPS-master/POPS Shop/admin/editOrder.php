<!DOCTYPE html>
  ...
  <?php
    ...
    $get_id = $_GET['editOrder'];
    $get_order = "SELECT DISTINCT Order_Num,Customer_ID,Tracking_Num,Street_Name,Order_Date,Item_Quantity,Payment_Type,Apt_Number,City,State,Zip,Status,Total,Order_Date FROM Orders NATURAL JOIN Payment_info NATURAL JOIN Order_Data where Order_Num ='$get_id'";
    ...
    $item_Quantity = $row_order['Item_Quantity'];
...
<body>
  ...
  <table>
    ...
    <input type="radio" name="status" value="Processed"> Processed
    <input type="radio" name="status" value="Shipped"> Shipped
    <input type="radio" name="status" value="Delivered"> Delivered
    <input type="radio" name="status" value="Reimbursed"> Reimbursed <br>
...
<?php
    if(isset($_POST['saveChanges']))
    {
      ...
      if($status == 'Processed')
      {
        $update_order = "update Orders set Status = '$status' where Order_Num = '$order_id'";
